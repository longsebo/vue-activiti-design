<template>
    <div>
        ...
        <el-form-item label="跳转条件" v-show="needConditiona">
                <el-input v-model="conditionsequenceflow" ></el-input>
        </el-form-item>
    ...
    watch:{
        element:{
            ...
            handler(element,oldVal){
                ...
                //加载条件
                this.loadCondition();
                this.conditionsequenceflow= element.businessObject.get( 'activiti:conditionsequenceflow');
            }
        },
        name: {
        ...
        conditionsequenceflow:{
          handler(newVal, oldVal) {
              this.modeling.updateProperties(this.element, {
                   'activiti:conditionsequenceflow': newVal
              })
          }
        },
        condition: {
